...
Run: sec3_2026-07-27T03-10-36-121Z
...
| C029 | concurrent |  | concurrent_accept_single_membership |  | allow | allow |  |  | ✅ | ok=1 deniedStable=TENANT_INVITATION_ALREADY_ACCEPTED members=1 |
| C030 | concurrent |  | concurrent_no_duplicate_success_audit |  | allow | allow |  |  | ✅ | success_audit_count=0 |
| C031 | existing_active |  | accept_existing_member_single_row |  | allow | allow | 200 |  | ✅ | role_after=guest |
| C032 | suspended_a |  | accept_suspended_no_bypass |  | deny | deny | 400 |  | ✅ | kept suspended |
| C033 | removed_a |  | accept_removed_becomes_member |  | allow | allow | 200 |  | ✅ |  |
...
| C038 | owner_a | A | revoke |  | allow | allow | 200 |  | ✅ |  |
| C039 | admin_a | A | revoke |  | allow | allow | 200 |  | ✅ |  |
| C040 | member_a | A | revoke |  | deny | deny | 403 | PERMISSION_DENIED | ✅ |  |
| C041 | guest_a | A | revoke |  | deny | deny | 403 | PERMISSION_DENIED | ✅ |  |
| C042 | outsider | A | revoke |  | deny | deny | 403 | PERMISSION_DENIED | ✅ |  |
| C043 | owner_b | A | revoke |  | deny | deny | 403 | PERMISSION_DENIED | ✅ |  |
| C044 | owner_a | A | revoke_accepted |  | deny | deny | 400 |  | ✅ |  |
| C045 | owner_a | A | revoke_repeat |  | deny | deny | 400 |  | ✅ | first=true |
| C046 | owner_b | A | cross_tenant_revoke |  | deny | deny | 403 | PERMISSION_DENIED | ✅ |  |
| C047 | cross_tenant |  | cross_tenant_scoped_membership |  | allow | allow |  |  | ✅ | A=true B=false |
| C048 | member_b | A | cross_tenant_list_invitations |  | deny | deny |  |  | ✅ | rows=0 |
| C049 | system |  | outbox_no_token |  | allow | allow |  |  | ✅ | events=1 |
| C050 | anonymous | A | accept | pending | deny | deny | 401 |  | ✅ |  |