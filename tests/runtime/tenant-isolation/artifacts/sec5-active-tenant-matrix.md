# SEC.5 Active Tenant Runtime Matrix (sec5_2026-07-27T05-36-06-557Z)
...
| C010 | B | multi_ab | setActive_A | allow | allow |  |
| C011 | B | multi_ab | setActive_B | allow | allow |  |
...
| C045 | M | multi_ab | two_tabs_both_selections_valid | allow | allow |  |
