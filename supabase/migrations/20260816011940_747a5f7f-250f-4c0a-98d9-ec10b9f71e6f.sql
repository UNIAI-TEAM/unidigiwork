...
my_notifs AS (
  SELECT n.id, n.type, n.title, n.body, n.link, n.meta, n.is_read, n.created_at
...
my_emails AS (
  SELECT s.message_id, s.is_starred, s.updated_at, em.subject, em.sent_at, em.thread_id
