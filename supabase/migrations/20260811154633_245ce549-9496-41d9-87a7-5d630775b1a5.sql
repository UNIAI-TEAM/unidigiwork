ALTER TABLE public.audit_events DROP CONSTRAINT audit_events_actor_user_id_fkey;
ALTER TABLE public.audit_events ADD CONSTRAINT audit_events_actor_user_id_fkey
  FOREIGN KEY (actor_user_id) REFERENCES public.users(id) ON DELETE SET NULL;

ALTER TABLE public.audit_events DROP CONSTRAINT audit_events_tenant_id_fkey;
ALTER TABLE public.audit_events ADD CONSTRAINT audit_events_tenant_id_fkey
