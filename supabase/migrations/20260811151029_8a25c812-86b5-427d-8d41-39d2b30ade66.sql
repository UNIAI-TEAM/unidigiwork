...
BEGIN
  ...
  IF _event_id IS NULL THEN
    RETURN NULL; -- duplicate idempotent submission: do not double count
  END IF;
  ...
  DO UPDATE SET total = GREATEST(public.usage_counters.total + EXCLUDED.total_delta_placeholder, 0);
