...
export const STABLE_ERROR_CODES = [
  ...
  "ENTITLEMENT_DENIED",
  "QUOTA_EXCEEDED",
  // Work Graph domain (Work Graph Foundation V1)
  ...
  "WORK_PRODUCT_PREFLIGHT_FAILED",
  // HARDEN-SELLWORK-1 — hợp đồng sản phẩm công việc phải gắn được trước khi chạy AI.
  ...
  "AI_RATE_LIMITED",
  // AI Task Execution V1
  "AI_WORKER_NOT_FOUND",
  "AI_WORKER_NOT_ASSIGNED",
  "AI_TASK_SPEC_REQUIRED",
  "AI_EXECUTION_NOT_FOUND",
  "AI_EXECUTION_NOT_REVIEWABLE",
  "AI_EXECUTION_NOT_PAUSED",
  "AI_ACTIONS_PENDING",
  "AI_STEP_NOT_FAILED",
  "AI_STEP_RETRY_NEEDS_NEW_REVISION",
  "AI_EXECUTION_ALREADY_FINISHED",
