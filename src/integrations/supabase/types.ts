...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      tenant_role: "tenant_owner" | "tenant_admin" | "manager" | "member" | "guest";
      workflow_run_status: "pending" | "running" | "succeeded" | "failed" | "canceled";
      workflow_status: "draft" | "published" | "archived";
      workflow_step_status: "pending" | "running" | "succeeded" | "failed" | "skipped";
    };
    CompositeTypes: {
      dblink_pkey_results: {
