          ...
          <section className="flex min-w-0 flex-1 flex-col overflow-y-auto">
            ...
            <article className="flex-1 px-4 py-6 sm:px-8">
              {selected ? (
                ...
                <p className="text-sm text-muted-foreground">Chọn một tài liệu từ thanh bên trái, hoặc bấm <kbd className="rounded bg-surface-2 px-1.5 py-0.5 text-xs">+</kbd> để tạo mới.</p>
              )}
            </article>
