            ...
            <div className="rounded-2xl border border-border bg-surface">
              ...
              <div className="px-5">
                <Field label="Đến">
                  ...
                  <button className="text-xs text-muted-foreground hover:text-foreground">Cc</button>
                  <button className="text-xs text-muted-foreground hover:text-foreground">Bcc</button>
                </Field>
                <Field label="Tiêu đề">
